...
if [ -v REDIRECTOR ]; then
  echo 2001:48d0:3001:111::400 xrootd-sense-ucsd-01.sdsc.optiputer.net > /etc/hosts
  echo 2001:48d0:3001:111::500 xrootd-sense-ucsd-02.sdsc.optiputer.net > /etc/hosts
  echo 2001:48d0:3001:111::600 xrootd-sense-ucsd-03.sdsc.optiputer.net > /etc/hosts
  echo 2001:48d0:3001:111::700 xrootd-sense-ucsd-04.sdsc.optiputer.net > /etc/hosts
